                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-500 text-sm leading-relaxed">
                            Definitive menswear for the modern individual. We craft pieces that blend contemporary aesthetics with timeless quality.
                        </p>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-gray-900 font-bold mb-6 font-display uppercase tracking-wider text-sm">Shop</h4>
                        <ul className="space-y-4 text-sm font-medium text-gray-500">
                            <li><Link to="/shop" className="hover:text-primary-600 transition-colors">All Products</Link></li>
                            <li><Link to="/shop?sort=-createdAt" className="hover:text-primary-600 transition-colors">New Arrivals</Link></li>
                            <li><Link to="/shop?sort=-sold" className="hover:text-primary-600 transition-colors">Best Sellers</Link></li>
                            <li><Link to="/shop?cat=sale" className="hover:text-primary-600 transition-colors">Sale</Link></li>
                        </ul>
                    </div>

                    {/* Customer Care */}
                    <div>
                        <h4 className="text-gray-900 font-bold mb-6 font-display uppercase tracking-wider text-sm">Support</h4>
                        <ul className="space-y-4 text-sm font-medium text-gray-500">
                            ...
                            <li><a href="#" className="hover:text-primary-600 transition-colors">Shipping & Returns</a></li>
                    ...
                    {/* Contact Info */}
                    <div>
                        <h4 className="text-gray-900 font-bold mb-6 font-display uppercase tracking-wider text-sm">Get in Touch</h4>
                        <ul className="space-y-4 text-sm font-medium text-gray-500">
