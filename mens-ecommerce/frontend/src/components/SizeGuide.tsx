    ...
    return (
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-8 md:p-12 border border-gray-200">
            <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div>
                    <h3 className="text-xl font-black text-gray-900 mb-6">Quick Size Finder</h3>
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {['Athletic', 'Slim', 'Regular', 'Broad'].map((type) => (
                                    <button
                                        key={type}
                                        onClick={() => setBodyType(type)}
                                        className={`px-4 py-3 rounded-xl font-bold text-sm transition-all ${bodyType === type
                        ...
                        <div className="bg-white rounded-xl p-4 border border-gray-200">
                            ...
                            <p className="text-2xl font-black text-gray-900">
                                ...
                                <span className="text-sm text-gray-500 ml-2 font-normal">
                                    {weight / Math.pow(height / 100, 2) < 18.5 ? 'Underweight' :
                                        weight / Math.pow(height / 100, 2) < 25 ? 'Normal' :
                                            weight / Math.pow(height / 100, 2) < 30 ? 'Overweight' : 'Obese'}
                                </span>
                            </p>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                    <h4 className="text-lg font-black text-gray-900 mb-6">Recommended Size</h4>
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-xs text-gray-500 mt-4">Perfect fit for your measurements</p>
                    </div>

                    {/* Measurements Table */}
                    <div className="space-y-3">
                        <div className="flex justify-between items-center py-3 border-b border-gray-100">
                            <span className="text-gray-600 font-semibold">Chest</span>
                            <span className="font-black text-gray-900">{measurements.chest} cm</span>
                        </div>
                        <div className="flex justify-between items-center py-3 border-b border-gray-100">
                            <span className="text-gray-600 font-semibold">Waist</span>
            ...
            <div className="text-center pt-6 border-t border-gray-200">
                <p className="text-xs text-gray-500 mb-4">
                    💡 Tip: These are general recommendations. For exact measurements, check our detailed size chart.
                </p>
                <Link to="/size-guide" className="text-primary-600 font-bold text-sm hover:underline">
                    View Full Size Guide & Chart →
                </Link>
            </div>
        </div>
    );
