...
const HomePage = () => {
    ...
    const words = ["Premium Style", "Modern Elegance", "Timeless Quality"];
    const typeSpeed = 100;
    ...
    const reviews = [
        {
            ...
            image: "https://ui-avatars.com/api/?name=Ahmed+Hassan&background=random"
        },
        {
            id: 2,
            name: "Mohamed Ali",
            rating: 5,
            text: "Best online shopping experience ever. Fast delivery and excellent customer service!",
            image: "https://ui-avatars.com/api/?name=Mohamed+Ali&background=random"
        },
        {
            id: 3,
            name: "Khaled Mahmoud",
            rating: 5,
            text: "The products exceeded my expectations. I'll definitely order again!",
            image: "https://ui-avatars.com/api/?name=Khaled+Mahmoud&background=random"
        }
    ];
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [catsRes, prodsRes, customRes] = await Promise.all([
                    api.get('/categories'),
        ...
        <div className="bg-white">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center text-white">
                    ...
                    <div className="flex justify-center gap-12 mb-8 animate-fade-in">
                        <div className="text-center">
                            ...
                            <div className="text-xs uppercase tracking-wider text-gray-400">Products</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-black text-accent-400">10K+</div>
                            <div className="text-xs uppercase tracking-wider text-gray-400">Customers</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-black text-accent-400">4.9★</div>
                            <div className="text-xs uppercase tracking-wider text-gray-400">Rating</div>
                        </div>
                    </div>
                    ...
                    <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
                        Upgrade your wardrobe with our curated collection of premium menswear.
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="flex flex-col items-center text-center group">
                            ...
                            <p className="text-sm text-gray-500">Hand-picked materials</p>
                        </div>
                        <div className="flex flex-col items-center text-center group">
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="flex justify-between items-end mb-12">
                        <div>
                            <h2 className="text-4xl font-black text-gray-900 mb-3">New Arrivals</h2>
                            <p className="text-gray-600">The latest trends fresh from the runway</p>
                        </div>
                ...
                <section className="py-20 bg-gradient-to-r from-indigo-50 to-blue-50">
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="text-4xl font-black text-gray-900 mb-4">Customizable Collection</h2>
                            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                                Add your unique touch to these premium products. Upload your design or choose from our exclusive templates.
                            </p>
                        </div>
                        ...
                        <div className="text-center mt-12">
                            ...
                            >
                                View All Customizable Products <FiArrowRight />
                            </Link>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {categories.map((cat, index) => (
                                ...
                                >
                                    ...
                                    <img
                                        src={
                                            index % 3 === 0 ? "https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?w=800" :
                                                index % 3 === 1 ? "https://images.unsplash.com/photo-1516257984-b1b4d8c9230c?w=800" :
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb-12">
                        <div className="flex items-center justify-center gap-3 mb-4">
                            ...
                            <h2 className="text-4xl font-black text-gray-900">Follow Us on Instagram</h2>
                        </div>
                        <p className="text-gray-600 text-lg">@topia.menswear</p>
                    </div>
            ...
            <section className="relative h-[600px] flex items-center justify-center overflow-hidden bg-fixed" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=1920)', backgroundAttachment: 'fixed', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div className="container mx-auto px-6 relative z-10 text-white max-w-4xl">
                    <div className="text-center">
                        <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight">Our Story</h2>
                        <div className="w-24 h-1 bg-accent-500 mx-auto mb-8"></div>
                        <p className="text-xl leading-relaxed mb-8 text-gray-200">
                            Founded in 2020, TOPIA has been redefining men's fashion with a perfect blend of contemporary design and timeless elegance.
                            We believe every man deserves to look and feel his best.
                        </p>
                        <p className="text-lg text-gray-300 mb-10">
                            Our mission is simple: to provide premium quality menswear that combines comfort, style, and affordability.
                            Each piece is carefully crafted with attention to detail and designed to elevate your everyday style.
                        </p>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-black text-gray-900 mb-4">Why Choose TOPIA?</h2>
                        <p className="text-gray-600 text-lg">We're committed to providing you the best shopping experience</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { icon: '✓', title: 'Premium Quality', desc: 'Hand-picked materials from the finest sources', color: 'from-blue-500 to-blue-600' },
                            { icon: '⚡', title: 'Fast Shipping', desc: 'Express delivery to your doorstep', color: 'from-yellow-500 to-orange-600' },
                            { icon: '↻', title: 'Easy Returns', desc: '30-day hassle-free return policy', color: 'from-green-500 to-green-600' },
                            { icon: '24/7', title: 'Support', desc: 'Always here to help you', color: 'from-purple-500 to-purple-600' }
                        ].map((benefit, index) => (
            ...
            <section className="py-16 bg-gray-900 overflow-hidden">
                <div className="container mx-auto px-6 mb-8">
                    <h3 className="text-center text-white text-sm font-black uppercase tracking-[0.3em] mb-2">Trusted By</h3>
                    <p className="text-center text-gray-400 text-xs">Official partner with leading fashion brands</p>
                </div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-12">
                            <h2 className="text-4xl font-black text-gray-900 mb-4">Find Your Perfect Fit</h2>
                            <p className="text-gray-600 text-lg">Use our interactive size guide to find the right size for you</p>
                        </div>
            ...
            <section className="py-24 bg-gradient-to-r from-gray-900 to-black text-white text-center relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 max-w-3xl relative z-10">
                    ...
                    <h2 className="text-4xl md:text-5xl font-black mb-6">Join the Elite</h2>
                    <p className="text-gray-400 mb-10 text-xl leading-relaxed">
                        Sign up for exclusive offers, early access to new collections, and style tips from our experts.
                    </p>
